 ...
 * and maps those symbols to substitutions. For example, the symbol â"personâ" might map to a {@link Choice} between
 * two {@link Literal}s, â"Aliceâ" and â"Bobâ".
 */
public class Grammar {
     ...
     * 
     * @param symbol  The lookup key for the symbol (e.g. â"personâ" in the example at the top of this class)
     */
